...
class Surface(object):
    ...
    def convert(cls, bytestring=None, *, file_obj=None, url=None, dpi=96,
                parent_width=None, parent_height=None, scale=1, unsafe=True,
                write_to=None, output_width=None, output_height=None, session=None, fillBG=False,
                **kwargs):
        ...
        """
        tree = Tree(
            bytestring=bytestring, file_obj=file_obj, url=url, session=session, unsafe=unsafe, fillBG=fillBG, isRoot=True,
            **kwargs)
    ...
    def __init__(self, tree, output, dpi, parent_surface=None,
                 ...
                 scale=1, output_width=None, output_height=None, session=None):
